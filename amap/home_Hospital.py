...
ora = Dba()
CaiJia_Sql = """
            INSERT INTO HOME_HOSPITAL(village,village_name,name,type,typecode,address,distance,location,tel) values('%s','%s','%s', '%s', '%s', '%s', '%s', '%s', '%s')
            """
...
type = '&types='
other = '&radius=5000&offset=20&page=1&extensions=base'
